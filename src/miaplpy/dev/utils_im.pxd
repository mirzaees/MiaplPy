...
cdef float complex[::1] squeeze_images(float complex[::1], float complex[:, ::1], int, int)
cdef tuple phase_linking_process_cy(float complex[:, ::1], int, bytes, int)
cpdef tuple phase_linking_process_py(float complex[:, ::1], int, bytes, bint, int, int)
...
cdef tuple real_time_phase_linking(float complex[:,::1], float complex[:,::1], float complex[:,::1], int, bytes, bint)
cdef tuple real_time_phase_linking_iterate(float complex[:,::1], int, bytes, int, int[:, ::1])
cdef float read_cutoff_csv_glrt(int, float)
...
cdef tuple time_referencing(cnp.ndarray[float complex, ndim=3], int, int, int)
cdef float complex compress_slcs(float complex[::1], float complex[::1])
cdef sequential_phase_linking(cnp.ndarray[float complex, ndim=3], bytes, int, int, int[:, ::1], bytes, cnp.ndarray[float complex, ndim=3], cnp.ndarray[float, ndim=2], cnp.ndarray[int, ndim=2], 
cnp.ndarray[float complex, ndim=3], cnp.ndarray[int, ndim=2])
cdef incremental_iterate(cnp.ndarray[float complex, ndim=3], bytes, int, int, int[:, ::1], bytes, cnp.ndarray[float complex, ndim=3], cnp.ndarray[float, ndim=2], cnp.ndarray[int, ndim=2], 
cnp.ndarray[float complex, ndim=3], cnp.ndarray[int, ndim=2])
cdef int get_reference_index(float complex[:, ::1])
#cpdef float[:, :] inverse_float_matrix(float[:, ::1])
#cdef (float, int) test_PS_cy(float complex[:, ::1], float[::1])